...
export function محلل_دالة(الرموز, الدالة_الام) {
    ...
    if (!تحقق(الرموز, "مسافة")) {
        return { نوع: "دالة", اسم: اسم.القيمة, معاملات, اوامر, الدالة_الام };
    }
    return {
        نوع: "دالة",
        اسم: اسم.القيمة,
...
export function منشئ_دالة(مستوى, عداد, عقدة, داخل_برنامج) {
    ...
    if (عقدة.الدالة_الام.includes("صنف"))
        return `${اسم}(${معاملات}) {\n${اوامر}\n}`;
...
export function محلل_إستدعاء_دالة(الرموز, الدالة_الام) {
    ...
    const هل_صنف = جلب_دالة(اسم)?.هل_صنف;
    if (!جلب_دالة(اسم) && !هل_صنف && اسم != "اصل")
...
export function منشئ_استدعاء_دالة(مستوى, عداد, عقدة) {
    ...
    if (عقدة.هل_صنف) return `new ${اسم}(${قيمة})`;
    return `${اسم}(${قيمة})`;
}
