...
function قراءة_عامل(الرموز) {
    ...
    if (تطابق(الرموز, "اقواس", "(")) {
        ...
        if (!تطابق(الرموز, "اقواس", ")"))
            رمي_خطأ(`لم يتم اغلاق القوس ")" بعد العمليات`, الرموز);
        return عقدة;
    }
    ...
    if (تحقق(الرموز, "رمز_حسابي", "ليس")) {
        التالي(الرموز);
        const عامل = محلل_التعبير_مع_الأولوية(الرموز, 1);
        return {
            نوع: "عملية",
            القيم: {
                يسار: عامل,
...
function محلل_التعبير_مع_الأولوية(الرموز, اقل_اولوية) {
    ...
    while (true) {
        ...
        const يمين = محلل_التعبير_مع_الأولوية(الرموز, الأولوية);
