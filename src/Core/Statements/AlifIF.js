...
export function محلل_اذا(الرموز, الدالة_الام) {
    ...
    // اوامر اذا
    اوامر_اذا = إدارة_المسافة_البادئة(الرموز, "اذا", "اذا");
...
export function محلل_اواذا(الرموز, الدالة_الام) {
    ...
    let اوامر_اواذا = إدارة_المسافة_البادئة(الرموز, "اواذا", الدالة_الام);
    if (!تحقق(الرموز, "مسافة")) {
...
export function محلل_والا(الرموز, الدالة_الام) {
    ...
    let اوامر_والا = إدارة_المسافة_البادئة(الرموز, "والا", الدالة_الام);
    if (!تحقق(الرموز, "مسافة")) {
