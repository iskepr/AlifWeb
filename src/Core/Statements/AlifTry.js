...
export function محلل_حاول(الرموز, الدالة_الام) {
    ...
    let اوامر_حاول = إدارة_المسافة_البادئة(الرموز, "حاول", الدالة_الام);
...
export function محلل_خلل(الرموز, الدالة_الام) {
    ...
    let اوامر_خلل = إدارة_المسافة_البادئة(الرموز, "خلل", الدالة_الام);
    if (!تحقق(الرموز, "مسافة")) {
...
export function محلل_نهاية(الرموز, الدالة_الام) {
    ...
    let اوامر_نهاية = إدارة_المسافة_البادئة(الرموز, "نهاية", الدالة_الام);
    if (!تحقق(الرموز, "مسافة")) {
