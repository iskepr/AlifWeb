...
export function محلل_حاول(الرموز) {
    تطابق(الرموز, "كلمة", "حاول");
    تطابق(الرموز, "نقطتان");

    let اوامر_حاول = إدارة_المسافة_البادئة(الرموز, "حاول");
...
export function محلل_خلل(الرموز) {
    تطابق(الرموز, "كلمة", "خلل");
    تطابق(الرموز, "نقطتان");

    let اوامر_خلل = إدارة_المسافة_البادئة(الرموز, "خلل");
    if (!تحقق(الرموز, "مسافة")) {
...
export function محلل_نهاية(الرموز) {
    تطابق(الرموز, "كلمة", "نهاية");
    تطابق(الرموز, "نقطتان");

    let اوامر_نهاية = إدارة_المسافة_البادئة(الرموز, "نهاية");
    if (!تحقق(الرموز, "مسافة")) {
